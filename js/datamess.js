...
jQuery.fn.extend({
    datagrid: function (params) {
        ...
        this.json = params.json;//请求json数据 (wbl)
        ...
        this.load_success = function (data) {
            ...
            console.log(thet.currentData)
            if (data && 200 == data[thet.listCode]) {
                //listCode   请求成功 200
                console.log(thet.listCode)
                if ("function" == typeof thet.successFn) {
                    //打印失效
                    alert(thet.successFn);
                    thet.successFn(data);
                }
                //清空tbody
                thet.tbody.empty();
                ...
                try {
                    ...
                    if (list && list.length) {
                        ...
                        for (var j = 0; j < listlen; j++) {
                            ...
                            console.log(thet.columnBgColor)
                            //单选 或多选
                            if (thet.multiple || thet.single) {
