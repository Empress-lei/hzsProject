...
var toast_timer_show_time = 20 * 1000;//提示消息显示时间长度
...
addCSS('.cuowu {  ' +
    ...
    '} ' +
    '.cuowu > div {  ' +
    'position: absolute;  width: 20%;  left: 50%;  margin-left: -10%;  background: rgba(0, 0, 0, 0.5);  margin-top: -1.78666667rem;  padding: 1rem;  top: 50%;  border-radius: 6px; ' +
    '} ' +
    '.cuowu > div span {  ' +
    'display: block;  text-align: center;  color: #fff; font-size: 15px; ' +
    '} ' +
    '.cuowu > div img {  ' +
    'display: block;  width: 1.06666667rem;  height: 1.09333333rem;  margin: 0 auto; ' +
    '} ' +
    '.cuowu .cw2 {  ' +
    '' +
    '} ' +
    '.load { ' +
    'width: 100%; height: 100%; position: fixed; left: 0; top: 0;z-index: 99999999; ' +
    '} ' +
    '.load .loading { ' +
    'width: 1.16rem; height: 1.16rem; position: relative; top: 50%; margin: -0.58rem auto 0 auto; background: url(/res/images/load-miao.png) no-repeat center center; background-size: 0.66666667rem; ' +
    '} ' +
    '.load .loadbg { ' +
    'width: 1.16rem; height: 1.16rem; ' +
    'background: url(/res/images/loadbg.png) no-repeat center center; ' +
    'background-size: 1.16rem 1.13333333rem; ' +
    'animation: rotate 100s linear infinite; -webkit-animation: rotate 100s linear infinite; ' +
    '-moz-animation: rotate 100s linear infinite; -o-animation: rotate 100s linear infinite; ' +
